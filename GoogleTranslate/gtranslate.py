...
if OUTPUTLANGUAGE == "all":
    LANGS = ["af","ak","sq","am","ar","hy","az","eu","be","bem","bn","bh","bs","br",
    "bg","km","ca","chr","ny","co","hr","cs","da","nl","en","eo","et","ee","fo","tl",
    "fi","fr","fy","gaa","gl","ka","de","el","gn","gu","ht","ha","haw","iw","hi","hu",
    "is","ig","id","ia","ga","it","ja","jw","kn","kk","rw","rn","kg","ko","kri","ku",
    "ckb","ky","lo","la","lv","ln","lt","loz","lg","ach","mk","mg","ms","ml","mt",
    "mi","mr","mfe","mo","mn",
    # "sr-ME",
    "ne","pcm","nso","no","nn","oc","or","om","ps","fa","pl",
    # "pt-BR","pt-PT",
    "pa","qu","ro","rm","nyn","ru","gd","sr",
    # "sh",
